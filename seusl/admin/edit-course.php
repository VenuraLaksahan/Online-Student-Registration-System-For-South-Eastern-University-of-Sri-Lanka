...
<div class="form-group">
    <label for="courseunit">Course Credit Value  </label>
    <input type="text" class="form-control" id="courseunit" name="courseunit" placeholder="Course Credit" value="<?php echo htmlentities($row['courseUnit']);?>" required />
  </div>  
